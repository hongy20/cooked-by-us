...
- Use `src/` for all application code. Clear separation between source code, configuration, and public assets
- Use the modern [App Router](https://nextjs.org/docs/app) instead of the old Pages Router
- Choose **Biome** instead of ESLint for faster performance and simplified configuration
